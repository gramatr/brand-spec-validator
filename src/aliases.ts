 ...
 * aliased.
 */
export function readAliased(data: Record<string, unknown>, aliasFor: string): AliasReadResult {
 ...
 */
export function findAliasByAnyName(name: string): FieldAlias | undefined {
 ...
 */
export function isLegacyAlias(usedName: string): boolean {
 ...
 */
export function canonicalFor(legacyName: string): string | undefined {
